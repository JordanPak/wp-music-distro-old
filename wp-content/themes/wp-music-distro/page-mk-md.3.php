				...
				<div id="main" class="col col-lg-12 clearfix" role="main">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<?php
							...
							// For Testing
							echo '<h4>Archive Page Info</h4>';
							echo '<p>
									<b>Parent Cat Name: </b>' . $parent_cat_name . '<br>
								  	<b>Parent Cat Slug: </b>' . $parent_cat_slug . '<br> 
									<b>Parent Cat Id: </b>' . $parent_cat_id . '<br>
								  </p>'
							;
                        	...
                        	<div class="col-xs-4">
                                ...
                                <form class="form-horizontal" role="form">
									...
									<?php 
										...
										// For Testing
										if( $selected != 0 ) {
											echo '<br><p><b>' . $selected_instrument_name . ' was selected (ID: '. $selected_instrument_id . ')</b></p>';
										}
										else {
											echo '<br><p><b>Please Select an Instrument</b></p>';
										}
                        	...
                        	<div class="col-md-12">
								...
								<?php
                                    ...
                                    {	
										...
										// For Testing
										echo '
											<h4>Selected Instrument Information</h4>
											<p>
												<b>Name: </b>' . $selected_instrument_name . '<br>
												<b>Slug: </b>' . $selected_instrument_slug . '<br>
												<b>ID: </b>'   . $selected_instrument_id   . '<br>
											</p>
											<br>
										';
										...
										if($arrangements->have_posts() ){
											...
											echo '<p><b>All ' . $selected_instrument_name . ' Arrangements</b></p><ul>';
